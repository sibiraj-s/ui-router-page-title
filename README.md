# ui-router-page-title [![Build Status](https://travis-ci.org/Sibiraj-S/ui-router-page-title.svg?branch=master)](https://travis-ci.org/Sibiraj-S/ui-router-page-title)
